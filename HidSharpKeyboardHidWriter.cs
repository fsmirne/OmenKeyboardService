...
/// <summary>
/// Shared HidSharp-based HID I/O for platforms with a HidSharp backend (Windows, macOS).
/// LED commands use Report ID 0, macro commands use Report ID 1.
/// </summary>
public abstract class HidSharpKeyboardHidWriter : IKeyboardHidWriter
{
    ...
    protected HidSharpKeyboardHidWriter(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public abstract bool TryForceReenumeration();
    ...
    protected HidDevice FindKeyboardDevice()
    {
